...
const ContinueWithGoogle: React.FC<ContinueWithGoogleProps> = ({ text }) => {
  return (
    <button className="flex justify-center items-center space-x-[12px] border-[#D0D5DD] dark:border-white hover:opacity-65 border dark:border-opacity-[30%] rounded-lg w-full h-[48px] text-black dark:text-white">
