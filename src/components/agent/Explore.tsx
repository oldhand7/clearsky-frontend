...
import { ExploreIcon } from '../../assets/icons/Icons';
...
const ExploreAgents: React.FC = () => {
  ...
  return (
    <div>
      <Modal className="border-gray-700 dark:bg-gray-800 border rounded-[24px]" isOpen={isModalOpen} onClose={handleCloseModal}>
        <div className="w-[1076px] space-x-[96px] flex mt-4 h-[761px] relative bg-white dark:bg-gray-800 rounded-xl p-8">
          ...
          <div className="mt-8">
            ...
            <div className='h-10 px-3.5 py-3 w-[403px] bg-white  rounded-full border dark:border-gray-700 justify-start items-center gap-2 inline-flex'>
      ...
      <div className='flex space-x-3 items-center h-[40px]' onClick={handleCreateClick}>
        <ExploreIcon/>
