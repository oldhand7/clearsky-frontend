    ...
    <div className="flex space-x-2">
      {!isSpeaking ? (
        <Button
          ...
          className={`flex items-center justify-center ${isConnecting ? 'bg-red-500' : 'bg-[#2E53DA]'}  shadow-md px-4 py-2 rounded-lg h-10 text-white transition duration-200 text-sm md:text-base`}
